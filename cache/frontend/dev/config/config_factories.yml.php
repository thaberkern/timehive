...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'D:\\www\\opensource\\timeboxx_reloaded_sf\\log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'D:\\www\\opensource\\timeboxx_reloaded_sf\\cache\\frontend\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'D:\\www\\opensource\\timeboxx_reloaded_sf\\apps\\frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'D:\\www\\opensource\\timeboxx_reloaded_sf\\cache\\frontend\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'D:\\www\\opensource\\timeboxx_reloaded_sf\\apps\\frontend/template',
)));
...
sfMailer::initialize();
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'DynamicConfigMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  'logging' => '1',
  'charset' => 'utf-8',

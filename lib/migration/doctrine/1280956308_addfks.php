...
class Addfks extends Doctrine_Migration_Base
{
    public function up()
    {
        $this->createForeignKey('tb_project', 'tb_project_user_id_tb_user_id', array(
             'name' => 'tb_project_user_id_tb_user_id',
             'local' => 'user_id',
             'foreign' => 'id',
    ...
    {
        $this->dropForeignKey('tb_project', 'tb_project_user_id_tb_user_id');
